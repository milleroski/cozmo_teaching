...
FileName = currentDT.strftime("%Y_%m_%d_%H_%M_%S") + "_cozmo_main_dialogue.log"
...
model = vosk.Model(os.path.abspath("../english/vosk-model-small-en-us-0.15"))
...
def cozmo_program(robot: cozmo.robot.Robot):
    ...
    confirmation_words = ["yes", "yet", "ya", "ok", "okay", "okey", "yeah", "sure", "correct", "is true", "indeed", "positive"]
    ...
    #say_text("Please try to give me clear answers if possible, and repeart your answer if I do not respond to you, as I'm still learning how to interact with humans!", robot)
