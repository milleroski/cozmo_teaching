...
def cozmo_program(robot: cozmo.robot.Robot):
    try:
        ...
        say_text("Hallo! Ich bin Cozmo! Dein Sprachlernpartner!", robot)
            ...
            while not correct:
                ...
                if text:
                    ...
                    if correct:
                        ...
                        say_text("Deine Antwort {}, ist richtig! Gut gemacht!".format(text), robot)
                        ...
                        first_try = False
                        say_text("Deine Antwort {}, ist leider falsch. ".format(text), robot)
                        number = random.randint(0, 9)
        ...
        fist_bump(robot)
        say_text("Du hast {} korrekte Antworten von {} Fragen. Das ist eine {} Prozentzahl.".format(first_try_counter, dict_length, percentage), robot)
